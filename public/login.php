    ...
    <div class="container bg-light">
        <div class="row pt-3 pb-3">
            ...
            <div class="col-sm-6 form-input-area">
                ...
                <!-- Receives the post_id to send it to processViewLoginRegister.php -->
                <?php
                if (isset($_GET['post_id'])) {
                    $pId = $_GET['post_id'];
                }
                if (isset($_GET['login-default'])) {
                    $default = $_GET['login-default'];
                    // echo $default;
                }
                ?>
                <form action="processViewerLoginRegister.php" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <?php
                            // Verifies if http request comes
                            // from single-post like button
                            if (!isset($default)) {
                                ?>
                            <input type="hidden" name="action" value="verify">
                            <input type="hidden" name="login_id" value="single-post-login">
                            <input type="hidden" name="single-post_id" value="<?php echo $pId; ?>">
                            ...
                            <?php
                                ...
                                // Http Request not from single post like button
                                // Http Request comes from Log in button of page top
                                ?>
                            <input type="hidden" name="action" value="verify">
                            <input type="hidden" name="login_id" value="login-default">
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-6">
                            <a href="#" name="submit-index" value="index-page-login"
                                class="btn btn-sm btn-success d-block"><i class="fab fa-facebook"></i> Facebook Log
                                in</a>
                        </div>
                        <div class="col-sm-6">
