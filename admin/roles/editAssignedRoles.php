        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <a href="userIndex.php" class="btn btn-sm btn-primary"><i class="fa fa-fast-backward"></i> User Index</a>
                ...
                <div class="box-body">
                    ...
                    */
                    ...
                    <form class="form" action="processAssignRole.php" method="post">
                        ...
                        <div class="form-group">
                            <button type="submit" name="submit" value="update-user-role"
                                class="btn btn-sm btn-primary"><i class="fa fa-user"></i> Edit User Role </button>
                        </div>
                    </form>
                    </form>
                    <!-- Code above -->
