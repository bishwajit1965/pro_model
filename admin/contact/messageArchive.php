        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <a href="contactIndex.php" class="btn btn-sm btn-primary"><i class="fa fa-list"></i> Contact Message Index</a>
                                    ...
                                    foreach ($contactData as $userContact) { ?>
                                        <tr>
                                            ...
                                            <td style="display: block;">
                                                ...
                                                <a class="btn btn-xs btn-primary btns"
                                                ...
                                                <form action="processContact.php" method="post" accept-charset="utf-8">
                                                    ...
                                                    <button type="submit" name="submit" value="update" class="btn btn-xs btn-success btns" onClick="return confirm('Do you really want to publish this message in public ? Then click OK !!!');"><i class="fa fa-list"></i> Publish Msg</button>
                                                </form>
                                                ...
                                                <form style="display:inline;" action="processContact.php" method="post" accept-charset="utf-8">
                                                    ...
                                                    <button type="submit" name="submit" value="delete" class="btn btn-xs btn-danger btns" onClick="return confirm('Do you really want to delete this data ?');"><i class="fa fa-trash"></i> Delete Msg</button>
                                                ...
                                                <style>
                                                    .btns {width:100%;margin-bottom: 2px;}
                                                </style>
                                            </td>
                                        </tr>
                                <?php }
