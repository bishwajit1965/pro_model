...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Add about us data <small> it all starts here</small>
            </h1>
            <ol class="breadcrumb">
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        ...
                        <form action="processAboutUs.php" method="post" accept-charset="utf-8">
                            <div class="form-group">
                              ...
                              <textarea class="form-control" name="about_us" id="editor1" rows="3"></textarea>
                            </div>
                             
                            <input type="hidden" name="action" value="verify">
                            <button type="submit" name="submit" value="insert" class="btn btn-sm btn-primary"><i class="fa fa-upload"></i> Add About Us</button>
                        </form>
                    </div>
                    <!-- Code above -->
                </div>
