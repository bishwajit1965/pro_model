                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="logout.php" class="btn btn-sm btn-danger"><span
                                                class="glyphicon glyphicon-fast-backward"></span> Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="../article/articleIndex.php"><i class="fa fa-circle-o"></i> Article Index</a>
                            </li>
                            <li><a href="../aboutUs/aboutUsIndex.php"><i class="fa fa-circle-o"></i> About Us Index</a>
                            </li>
                            <li><a href="../category/categoryIndex.php"><i class="fa fa-circle-o"></i> Category
                                    Index</a></li>
                            <li><a href="../copyright/copyrightIndex.php"><i class="fa fa-circle-o"></i> Copyright
                                    Index</a></li>
                            <li><a href="../footer/footerIndex.php"><i class="fa fa-circle-o"></i> Footer Index</a></li>
                            ...
                            <li><a href="../socialMedia/socialMediaIndex.php"><i class="fa fa-circle-o"></i> Social
                                    Media Index</a></li>
                            ...
                            <li><a href="../contact/contactIndex.php"><i class="fa fa-circle-o"></i> Contact Index</a>
                            </li>
