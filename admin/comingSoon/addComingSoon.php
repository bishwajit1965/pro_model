...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add coming soon post <small>it all starts here</small>
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <a href="comingSoonIndex.php" class="btn btn-sm btn-primary"><i class="fa fa-list"></i> Coming Soon
                        Index</a>
                ...
                <div class="box-body">
                    ...
                    ?>
                    <form action="processComingSoon.php" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="title">Coming Soon Post Status</label>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="title">Coming soon photo </label>
                                    <input type="file" name="photo" class="form-control">
                                </div> 
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="title">Coming Soon Post Will Publish on</label>
                        ...
                        <div class="form-group">
                            <label for="title">Coming Soon Post Dscription</label>
                            <textarea id="editor1" name="description" rows="5" cols=""></textarea>
                        </div>
                        <input type="hidden" name="action" value="verify">
                        <button type="submit" name="submit" value="insert" class="btn btn-sm btn-primary"><i class="fa fa-upload"></i> Add Coming Soon Post</button>
                    </form>
                    <!-- Code above -->
                </div>
                <!-- /.box-body -->
