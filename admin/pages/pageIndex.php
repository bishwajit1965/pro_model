        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    use CodeCourse\Repositories\Page as Page;
                    ...
                    ?>
                    <form action="processPage.php" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="page_title">Page Title</label>
                                    <input type="text" name="page_title" class="form-control" value="" placeholder="Insert page title">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
